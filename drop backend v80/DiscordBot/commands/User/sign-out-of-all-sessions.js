...
module.exports = {
    commandInfo: {
        ...
        description: "Signs you out of all sessions from your account."
    },
    execute: async (interaction) => {
        ...
        if (accessToken != -1 || refreshToken != -1) {
            ...
            return interaction.editReply({ content: `You have been signed out of all sessions successfully!`, ephemeral: true });
        }
        
        interaction.editReply({ content: `Your account is not currently connected to any session.`, ephemeral: true });
    }
}