...
module.exports = {
    commandInfo: {
        name: "addvbucks",
        description: "lets you change a users amount of vbux",
        options: [
            {
                name: "user",
                description: "the user you want to change the vbux of",
                required: true,
                type: 6
            },
            {
                name: "vbucks",
                description: "the amount of vbux you want to give (can be negative to deduct vbux)",
                required: true,
                type: 4
            }
        ]
    ...
    execute: async (interaction) => {
        ...
        common_core.items[purchaseId] = {
            ...
            "attributes": {
                ...
                "lootList": lootList,
                "params": {
                    "userMessage": `Have a wonderful day. Thank you for playing Rift!`
                },
